        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a href="{{ url('/') }}"><img src="{{ asset('frontassets/tta/img/logo/logo.png') }}" alt="" /></a>
                    </div>
                </div>
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav notika-top-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><span>Welcome :- {{ Auth::user()->name }}</span> <span class="caret"></span></a>
                            ...
                            <ul class="mobile-menu-nav">
                                <li><a data-toggle="collapse" data-target="#Charts" href="#">Home</a>
                                    <ul class="collapse dropdown-header-top">
                                        <li><a href="{{ route('home') }}">Check for updates</a></li>
                                    </ul>
                                </li>
                                @if (!Auth::guest())
                                ...
                                <li><a data-toggle="collapse" data-target="#democrou" href="#">Profile</a>
                                    <ul id="democrou" class="collapse dropdown-header-top">
                                        <li><a href="{{ route('profile') }}">Company logo</a></li>
                                ...
                                <li><a data-toggle="collapse" data-target="#demolibra" href="#">Pack Balance</a>
                                    <ul id="demolibra" class="collapse dropdown-header-top">
                                        <li><a href="{{ route('home') }}">Check for pack balance</a></li>
                                    </ul>
                                </li>
                                <li><a data-toggle="collapse" data-target="#demodepart" href="#">Custom Review Form</a>
                                    <ul id="demodepart" class="collapse dropdown-header-top">
                                        <li><a href="{{ route('managereviewform') }}">Manage Review Form</a></li>
                                    </ul>
                                </li>
                                @endif
                                @guest
                    ...
                    <div class="tab-content custom-menu-content">
                        <div id="Home" class="tab-pane in active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="{{ route('home') }}">Check for updates</a>
                                </li>
                            </ul>
                        </div>
                        <div id="mailbox" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                            <li><a href="{{ route('reviewrequestssent') }}">Review Requests</a></li>
                                        <li><a href="{{ route('reviewsgiven') }}">Reviews Given</a></li>
                                        <li><a href="{{ route('home') }}">Send review request</a></li>
                            </ul>
                        </div>
