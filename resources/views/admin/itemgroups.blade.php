                ...
                <div class="card-body">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            ITEM GROUPS  <span style="float:right;"><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                                    ADD NEW
                                </a></span>
                        </div>
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                            <form method="POST" action="#" id="additemgroup">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="form-row">
                                                        <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="groupcode" type="text"
                                                                    ...
                                                                    value="G{{ $lastId }}" required autocomplete="groupcode" autofocus readonly>
                            ...
                            <div class="modal fade" id="groupModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                            <form method="POST" action="#" id="edititemgroup">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <td><a href="itemgroupdestroy/{{ $itemgroup->id }}" class="btn btn-primary" onclick="return confirm('Are you sure?')">Delete</a>
                                    <a style="margin-top:5px;" class="btn btn-primary itemgroupedit" id="Itemgroup#{{ $itemgroup->id }}">Edit</a></td>
                                        </tr>
                                        @endforeach
