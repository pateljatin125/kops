            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.createuser') }}">Add User</a>
                        <a class="nav-link" href="{{ route('admin.show') }}">View Users</a>
                        <a class="nav-link" href="{{ route('admin.departments') }}">Manage Departments</a>
                        <a class="nav-link" href="{{ route('admin.groups') }}">Manage Groups</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayoutsV" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.vendors') }}">Manage Vendors</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts10" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.rawmaterialinward') }}">RAW MATERIAL INWARD</a>
                    </nav>
                </div>
                
                <div class="collapse" id="collapseLayouts10" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.rawmaterialstock') }}">RAW MATERIAL STOCK</a>
                    </nav>
                </div>
                <div class="collapse" id="collapseLayouts10" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.transferreport') }}">Transfer Report</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.items') }}">Manage ITEMS</a>
                    </nav>
                </div>
                <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.itemgroups') }}">Manage ITEM GROUPS</a>
                    </nav>
                </div>
                
                <div class="collapse" id="collapseLayouts1" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.itemgrouprelation') }}">ITEM GROUP RELATIONSHIP</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.casting') }}">Manage CASTING IN</a>
                        <a class="nav-link" href="{{ route('admin.castingoutput') }}">Manage CASTING OUT</a>
                        <a class="nav-link" href="{{ route('admin.transferreportcasting') }}">Reporting</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.items') }}">Manage MACHINING IN</a>
                         <a class="nav-link" href="{{ route('admin.items') }}">Reporting</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts4" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.items') }}">Manage STORE IN</a>
                         <a class="nav-link" href="{{ route('admin.items') }}">Reporting</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts5" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.items') }}">Manage PUMP IN</a>
                         <a class="nav-link" href="{{ route('admin.items') }}">Reporting</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts6" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.items') }}">Manage GRINDER IN</a>
                         <a class="nav-link" href="{{ route('admin.items') }}">Reporting</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts7" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.items') }}">Manage NICKEL IN</a>
                         <a class="nav-link" href="{{ route('admin.items') }}">Reporting</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts8" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.items') }}">Manage CP STORE</a>
                         <a class="nav-link" href="{{ route('admin.items') }}">Reporting</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts9" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('admin.items') }}">Manage REJECTION</a>
                         <a class="nav-link" href="{{ route('admin.items') }}">Reporting</a>
                    </nav>
                </div>
