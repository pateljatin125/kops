...
<body class="sb-nav-fixed">
    <?php echo $__env->make('admin.includes.topnav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(asset('adminassets/assets/demo/chart-area-demo.js')); ?>"></script>
    <script src="<?php echo e(asset('adminassets/assets/demo/chart-bar-demo.js')); ?>"></script>
    <script src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js" crossorigin="anonymous"></script>
    <script src="https://cdn.datatables.net/1.10.20/js/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script>
    <script src="<?php echo e(asset('adminassets/assets/demo/datatables-demo.js')); ?>"></script>
...
<script type="text/javascript" src="https://cdn.datatables.net/v/dt/jszip-2.5.0/dt-1.11.0/b-2.0.0/b-html5-2.0.0/datatables.min.js"></script>
    ...
    <script src="<?php echo e(asset('adminassets/js/ajaxcalls.js')); ?>"></script>
...
<?php /**PATH /home/jatin/Web/kops/resources/views/admin/layouts/app.blade.php ENDPATH**/ ?>